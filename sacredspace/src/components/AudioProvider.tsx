...
export function AudioProvider({ children }: { children: ReactNode }) {
  ...
  function seekFromEvent(e: React.MouseEvent<HTMLDivElement> | React.KeyboardEvent<HTMLDivElement>) {
    const el = audioRef.current;
  ...
  function handleProgressKeyDown(e: React.KeyboardEvent<HTMLDivElement>) {
    ...
    switch (e.key) {
      case "ArrowRight":
        ...
        break;
      case "ArrowLeft":
        newTime = Math.max(0, el.currentTime - step);
        break;
      case "Home":
        newTime = 0;
        break;
          ...
          <div className="mx-auto flex h-full max-w-4xl flex-col px-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  <div
                    ...
                    className="flex-1 overflow-hidden cursor-pointer group outline-none focus-visible:ring-2 focus-visible:ring-accent-gold focus-visible:ring-offset-2 rounded"
                  ...
                  <span className="shrink-0 text-xs tabular-nums text-on-surface-variant" aria-hidden="true">
                    {fmt(currentTime)} / {fmt(duration)}
                  </span>
                </div>
                <div className="mt-0.5 truncate text-xs text-on-surface-variant" aria-live="polite" aria-atomic="true">
            ...
            {expanded && (
              <div className="flex items-center gap-6 pb-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs text-on-surface-variant" id="volume-label">Volume</span>
                  <input
                    type="range"
                    min="0"
                    max="1"
